...
# -= Resources =-
#
#SBATCH --job-name=Setup2-AccentVC
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
/raid/users/ayesilkanat/anaconda3/envs/cuda10/bin/python main.py -c config_256x128.yaml -d spectrograms/sr_24000_mel_norm_128frame_256mel -train_set train_128 -train_index_file train_samples_128.json -store_model_path ../models/setup2 -t setup2_model-128segment -iters 100000 -summary_step 500
